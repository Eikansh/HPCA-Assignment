...
int main(int argc, char *argv[])
{
    ...
    //TO REMOVE
    double ref_time = (double)TIME_DIFF(std::chrono::microseconds, begin, end);
    ...
    //TO REMOVE
    double single_time = (double)TIME_DIFF(std::chrono::microseconds, begin, end);
    cout << "Speedup: " << ref_time/single_time << "\n";
    ...
    //TO REMOVE
    double multi_time = (double)TIME_DIFF(std::chrono::microseconds, begin, end);
    cout << "Speedup: " << ref_time/multi_time << "\n";
